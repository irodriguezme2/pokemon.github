...
public class JwtUtil {
	...
	public String generateToken(UserDetails userDetails) {
		...
		if (userDetails instanceof Usuario) {// si es un usuario
			Usuario user = (Usuario) userDetails;
			claims.put("role", user.getRole().name());// revisa que roles existen
		}

		return createToken(claims, userDetails.getUsername());// a partir del rol genera el token
	}
	...
	private String createToken(Map<String, Object> claims, String subject) {
		return Jwts.builder().setClaims(claims)// rol
	...
	public Boolean validateToken(String token, UserDetails userDetails) {
		// valida que sea un jwt activo NO EXPIRADO
